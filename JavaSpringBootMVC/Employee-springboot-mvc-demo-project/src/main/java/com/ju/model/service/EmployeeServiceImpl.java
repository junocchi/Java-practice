...
import com.ju.model.persistence.EmployeeDao;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public boolean addEmployee(Employee employee) {
		try {
			if (employeeDao.insertEmployee(employee.getEmpId(), employee.getEmpName(), employee.getEmpDesignation(),
					employee.getEmpDepartment(), employee.getEmpSalary()) > 0)
				return true;
		} catch (Exception ex) {
			return false;
		}
